...
class JiraService {
    ...
    attachmentToTicket(key: string, file: any): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            const url = process.env.url + `rest/api/2/issue/${key}/attachments`
            var headers = {
                ...form.getHeaders(),
